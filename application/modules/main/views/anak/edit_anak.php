  ...
  <div class="content-wrapper">
      ...
      <?php if ($this->session->flashdata('success')): ?>
        <div class="box-body">
          <div class="alert alert-info alert-dismissible">
            ...
            <a href="<?php echo base_url('main/Anggota_controller/detail/'.$anak->id_anggota) ?>">Saya Mengerti</a>
          </div>
        </div>
      <?php endif; ?>
      <!-- Alert -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('main/Anggota_controller/index') ?>">Lihat Data Anggota</a></li>
        <li><a href="<?php echo base_url('main/Anggota_controller/detail/'.$anak->id_anggota) ?>">Lihat Data Detail</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('main/Anak_controller/edit/'.$anak->id_anak) ?>" method="post">
