    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('main/Anggota_controller') ?>">Lihat Data Anggota</a></li>
        </ol>
      </section>
                  ...
                  <tbody>
                    ...
                    <?php foreach ($anak as $nilai): ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-ref" href="<?php echo site_url('main/Anak_controller/edit/'.$nilai->id_anak) ?>"><i class="fa fa-fw fa-edit"></i>Edit</a>
                          <a href="#!" onclick="deleteConfirm('<?php echo site_url('main/Anak_controller/delete/'.$nilai->id_anak) ?>')" class="btn btn-mandarin"><i class="fa fa-fw fa-trash"></i>Hapus</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                  ...
                  <tbody>
                    ...
                    <?php foreach ($pasangan as $nilai): ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-ref" href="<?php echo site_url('main/Pasangan_controller/edit/'.$nilai->id_pasangan) ?>"><i class="fa fa-fw fa-edit"></i>Edit</a>
                          <a href="#!" onclick="deleteConfirm('<?php echo site_url('main/Pasangan_controller/delete/'.$nilai->id_pasangan) ?>')" class="btn btn-mandarin"><i class="fa fa-fw fa-trash"></i>Hapus</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
