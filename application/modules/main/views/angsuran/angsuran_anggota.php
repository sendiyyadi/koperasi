<?php $this->load->view('_head'); ?>
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url('main/Pinjaman_controller') ?>"><i class="fa fa-fw fa-money"></i> Lihat
						Pinjaman</a></li>
									...
									<tr>
										...
										<td>
											<a class="btn btn-primary"
											   href="<?php echo site_url('main/Angsuran_controller/detailAngsuran/' . $value->id_anggota) ?>">
