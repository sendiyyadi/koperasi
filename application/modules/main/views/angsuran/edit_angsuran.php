<?php $this->load->view('_head'); ?>
  ...
  <div class="content-wrapper">
      ...
      <?php if ($this->session->flashdata('success')): ?>
        <div class="box-body">
          <div class="alert alert-info alert-dismissible">
            ...
            <a href="<?php echo base_url('main/Angsuran_controller/') ?>">Saya Mengerti</a>
          </div>
        </div>
      <?php endif; ?>
      <!-- Alert -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('main/Angsuran_controller/') ?>"><i class="fa fa-fw fa-child"></i>Lihat Data Angsuran</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('main/Angsuran_controller/edit/'.$angsuran->id_angsuran) ?>" method="post">
