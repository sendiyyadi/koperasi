        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <a href="<?php echo base_url('main/Angsuran_controller/listPinjamanAnggota') ?>" class="btn btn-tosca"><i class="fa fa-fw fa-plus"></i>Tambah</a>
                  ...
                  <tbody>
                    ...
                    <?php foreach ($angsuran as $value): ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-ref" href="<?php echo site_url('main/Angsuran_controller/edit/'.$value->id_angsuran) ?>"><i class="fa fa-fw fa-edit"></i></a><br><br>
                          <a href="#!" onclick="deleteConfirm('<?php echo site_url('main/Angsuran_controller/delete/'.$value->id_angsuran) ?>')" class="btn btn-mandarin"><i class="fa fa-fw fa-trash"></i></a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
