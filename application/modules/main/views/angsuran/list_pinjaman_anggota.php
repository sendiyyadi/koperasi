<?php $this->load->view('_head'); ?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="<?php  echo base_url('main/Angsuran_controller') ?>"><i class="fa fa-fw fa-money"></i> Lihat Angsuran</a></li>
                  ...
                  <tbody>
                    ...
                    <?php foreach ($pinjaman_anggota as $value): ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-primary" href="<?php echo site_url('main/Angsuran_controller/add/'.$value->id_pinjaman) ?>"><i class="fa fa-fw fa-plus"></i>Angsuran</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
