        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-primary">
              ...
              <!-- /.box-header -->
              <!-- form start -->
              <form role="form" action="<?php echo base_url('main/Ref_bidang/add') ?>" method="post">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    <label>Kode</label>
                    <input name="kode" class="form-control <?php echo form_error('kode') ? 'is-invalid':'' ?>" placeholder="Masukan Kode Bidang" type="text"/>
                    <div class="invalid-feedback">
                  ...
                  <div class="form-group">
                    <label>Nama</label>
                    <input name="nama" class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>" placeholder="Masukan Nama Bidang" type="text">
                    <div class="invalid-feedback">
                  ...
                  <div class="form-group">
                    <label>Alamat</label>
                    <input name="alamat" class="form-control <?php echo form_error('alamat') ? 'is-invalid':'' ?>" placeholder="Masukan Alamat Bidang" type="text"/>
                    <div class="invalid-feedback">
