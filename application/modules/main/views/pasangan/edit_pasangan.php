  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('main/Anggota_controller/detail/'.$pasangan->id_anggota) ?>">Lihat Data Detail</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('main/Pasangan_controller/edit/'.$pasangan->id_pasangan) ?>" method="post">
