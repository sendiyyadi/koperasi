    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('main/Anak_controller/form/'.$anggota->id_anggota) ?>">Tambah Data Anak</a></li>
        </ol>
      </section>
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="box box-primary">
              ...
              <form role="form" action="<?php echo base_url('main/Pasangan_controller/add/'.$anggota->id_anggota) ?>" method="post">
