  ...
  <div class="content-wrapper">
    ...
    <?php if ($this->session->flashdata('success')): ?>
      <div class="alert alert-success" role="alert">
        ...
        <a href="<?php echo base_url('main/Pegawai_controller/index') ?>">Ok</a>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('main/Pegawai_controller/index') ?>">Lihat Data Pegawai</a></li>
        <li><a href="<?php echo base_url('main/Pegawai_controller/add') ?>">Tambah Data Pegawai</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('main/Pegawai_controller/edit/'.$pegawai->id_pegawai) ?>" method="post">
