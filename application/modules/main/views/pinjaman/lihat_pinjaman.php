        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <a href="<?php echo base_url('main/Pinjaman_controller/list_anggota') ?>" class="btn btn-tosca"><i class="fa fa-fw fa-plus"></i>Tambah</a>
                  ...
                  <tbody>
                    ...
                    <?php foreach ($pinjaman as $value): ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-ref" href="<?php echo site_url('main/Pinjaman_controller/edit/'.$value->id_pinjaman) ?>"><i class="fa fa-fw fa-edit"></i></a>
                          <a href="#!" onclick="deleteConfirm('<?php echo site_url('main/Pinjaman_controller/delete/'.$value->id_pinjaman) ?>')" class="btn btn-mandarin"><i class="fa fa-fw fa-trash"></i></a>
