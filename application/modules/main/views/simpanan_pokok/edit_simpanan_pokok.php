  ...
  <div class="content-wrapper">
      ...
      <?php if ($this->session->flashdata('success')): ?>
        <div class="box-body">
          <div class="alert alert-info alert-dismissible">
            ...
            <a href="<?php echo base_url('main/SimpananPokok_controller/detail/'.$simpanan_pokok->id_anggota) ?>">Saya Mengerti</a>
          </div>
        </div>
      <?php endif; ?>
      <!-- Alert -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('main/SimpananPokok_controller/index') ?>">Lihat Anggota</a></li>
        <li><a href="<?php echo base_url('main/SimpananPokok_controller/detail/'.$simpanan_pokok->id_anggota) ?>">Lihat Detail Simpanan Pokok Anggota</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('main/SimpananPokok_controller/edit/'.$simpanan_pokok->id_simpanan_pokok) ?>" method="post">
