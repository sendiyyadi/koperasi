    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('main/SimpananSukarela_controller') ?>">Lihat Data Anggota</a></li>
        </ol>
      </section>
                  ...
                  <tbody>
                    ...
                    <?php foreach ($simpanan_sukarela as $nilai): ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-ref" href="<?php echo site_url('main/SimpananSukarela_controller/edit/'.$nilai->id_simpanan_sukarela) ?>"><i class="fa fa-fw fa-edit"></i>Edit</a>
                         <a href="#!" onclick="deleteConfirm('<?php echo site_url('main/SimpananSukarela_controller/delete/'.$nilai->id_simpanan_sukarela) ?>')" class="btn btn-mandarin"><i class="fa fa-fw fa-trash"></i>Hapus</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
