<?php $this->load->view('_head'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('main/SimpananSukarela_controller/index') ?>"><i class="fa fa-fw fa-child"></i>Lihat Data Anggota</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url('main/SimpananSukarela_controller/add/'.$anggota->id_anggota) ?>" method="post">
