                  ...
                  <tbody>
                    ...
                    <?php foreach ($anggota as $value): ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-primary" href="<?php echo site_url('main/SimpananWajib_controller/add/'.$value->id_anggota) ?>"><i class="fa fa-fw fa-plus"></i>Simpanan Wajib</a>
                          <a class="btn btn-success" href="<?php echo site_url('main/SimpananWajib_controller/detail/'.$value->id_anggota) ?>"></i>Detail Simpanan Wajib</a>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
